...
// NewGoExampleAPI creates a new GoExample instance
func NewGoExampleAPI(spec *loads.Document) *GoExampleAPI {
	return &GoExampleAPI{
...
/*GoExampleAPI This is a sample server Petstore server.  You can find out more about Swagger at [http://swagger.io](http://swagger.io) or on [irc.freenode.net, #swagger](http://swagger.io/irc/).  For this sample, you can use the api key `special-key` to test the authorization filters. */
type GoExampleAPI struct {
	spec            *loads.Document
...
func (o *GoExampleAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *GoExampleAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *GoExampleAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *GoExampleAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *GoExampleAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *GoExampleAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *GoExampleAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the GoExampleAPI
func (o *GoExampleAPI) Validate() error {
...
func (o *GoExampleAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *GoExampleAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *GoExampleAPI) Authorizer() runtime.Authorizer {
...
func (o *GoExampleAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
func (o *GoExampleAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *GoExampleAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the go example API
func (o *GoExampleAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *GoExampleAPI) initHandlerCache() {
...
func (o *GoExampleAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *GoExampleAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *GoExampleAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
