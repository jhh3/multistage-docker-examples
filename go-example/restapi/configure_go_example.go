...
import (
	...
	"github.com/jhh3/multistage-docker-examples/go-example/restapi/operations"
	"github.com/jhh3/multistage-docker-examples/go-example/restapi/operations/pet"
	"github.com/jhh3/multistage-docker-examples/go-example/restapi/operations/store"
	"github.com/jhh3/multistage-docker-examples/go-example/restapi/operations/user"
)

//go:generate swagger generate server --target ../../go-example --name GoExample --spec ../pet-store-swagger.json

func configureFlags(api *operations.GoExampleAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.GoExampleAPI) http.Handler {
